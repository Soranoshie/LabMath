...
{
    // Закомментировать ненужные вызовы методов в Main при проверке каждой лабораторной работы
    public static void Main()
    {
        // Лабораторная работа №1 : Архиваторы
        // ArchiverLab.ArchiverLab.Execute();
        
        // Лабораторная работа №2 : Помехоустойчивое кодирование (лабораторная работа из приложения)
